...
import paystackRouter, { webhookHandler } from "./src/routes/paystack.js";
...
// mount the payments router (initialize, verify etc)
app.use("/api/payments", paystackRouter);

// mount webhook separately with raw body parser so HMAC verification works
